        ...
        {   
            private static List<Team> Teams = new List<Team>(){
                ...
                new Team{
                    ...
                    Stadium = "Nef Stadyumu", Colors = "Sarı - Kırmızı"
                },
                new Team{
                    Id=3,Name = "Fenerbahçe",City = "İstanbul",FoundedDate = 1907,
                    Stadium = "Şükrü Saracoğlu Stadyumu",Colors = "Sarı - Lacivert"
                },
                new Team{
                    Id=4,Name = "Trabzonspor",City = "Trabzon",FoundedDate = 1961,
                    Stadium = "Şenol Güneş Spor Kompleksi", Colors = "Bordo - Mavi"
                }
            ...
            public List<Team> GetTeams(){
                var teams = Teams.OrderBy(t=>t.Id).ToList();
                return teams;
            }
